...
class QBetterListWidget(QTreeView):
    ...
    def __init__(self, headers: list = None, minimumSectionSize: int = 50, alignmentFlag: Qt.AlignmentFlag = Qt.AlignmentFlag.AlignLeft):
        super().__init__()
    ...
    def addItem(self, items: list, icon = None, alignmentFlag: Qt.AlignmentFlag = Qt.AlignmentFlag.AlignLeft):
    ...
    def clear(self):
        self.treeViewModel.removeRows(0, self.treeViewModel.invisibleRootItem().rowCount() - 1)
